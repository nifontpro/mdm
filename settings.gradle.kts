...
include(":common:user")
include(":common:user:domain")
include(":common:user:data")
include(":common:user:presenter")
include(":common:user:compose")

include(":common:event")
include(":common:event:domain")
include(":common:event:data")
include(":common:event:presenter")
include(":common:event:compose")